...
$route['employee/get-data-emp'] = 'employee/get_data_emp';
$route['employee/get-detail-emp'] = 'employee/get_detail_emp';
$route['employee/update-emp'] = 'employee/update_emp';

// city
$route['city/get-city'] = 'city/get_city';
